...
class AppButtonStyleTokens {
  ...
  static AppButtonStyleTokens resolve(
    AppButtonVariant variant,
    AppButtonSize size,
  ) {
    return switch (variant) {
      AppButtonVariant.primary => const AppButtonStyleTokens(
        noiseEnabled: true,
        noiseOpacity: 0.6,
        noiseScale: 1,
        curvature: 10,
      ...
      AppButtonVariant.inline => const AppButtonStyleTokens(
        noiseEnabled: false,
        noiseOpacity: 0,
        noiseScale: 1,
        curvature: 10,
        labelColor: Color(0xCC1F1F1F),
        bgGradient: null,
...
abstract final class AppButtonTokens {
  ...
  /// Multiplier applied to the press-in scale animation. `1.0` is the tuned
  /// default; raise it for a more pronounced squish, lower it to dampen.
  static const pressSensitivity = 1.0;
